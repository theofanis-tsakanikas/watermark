...
.PHONY: claims
claims: core-pure adapter-thin parity-independent partition-vocabulary schemas-agree flink-versions contracts-validate seed-check claim-1 claim-2 claim-3 claim-4 claim-5 claim-6 claim-7 policy cost ## Every claim gate that exists today
...
.PHONY: schemas-agree
schemas-agree: ## The registered payload schema and the normaliser describe the same fleet
	$(PY) scripts/check_schemas_agree.py
